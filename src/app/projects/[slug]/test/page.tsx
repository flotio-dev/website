 ...
 * Keeps the same behavior: when a numeric id is used it fetches the project and redirects
 * to the slug-based /projects/{slug}/overview route; otherwise appends /overview.
 */

// (The rest of the file content remains the same as the original project-detail/page.tsx)
                ...
                <Table>
                  ...
                  <TableBody>
                    {project.recentBuilds.map((b, i) => (
                      ...
                      >
                        <TableCell>
                          <MUILink href={`/projects/${project.slug}/builds`} underline="none">
                            {b.id}
                          </MUILink>
                        </TableCell>
